...
{
    public class PlateDropletWithThreeItemsInRedData : IEnumerable<object[]>
    {
        public IEnumerator<object[]> GetEnumerator()
        {
            yield return new object[]
            {
                ...
                {
                    {
                        WellNode.FromData(0, 50), WellNode.FromData(1, 50), WellNode.FromData(2, 1000), WellNode.FromData(3, 1000)
                    },
                    {
                        WellNode.FromData(4, 50), WellNode.FromData(5, 50), WellNode.FromData(6, 1000), WellNode.FromData(7, 1000)
                    },
                    {
